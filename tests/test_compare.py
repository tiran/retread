...
@pytest.mark.parametrize(
    ...
    [
        ...
        # auto-generated source files (always NOTICE)
        ("foo/bar_pb2.py", False, NOTICE, Classification.GENERATED),
        ("foo/bar_pb2.py", True, NOTICE, Classification.GENERATED),
        ("foo/bar_pb2_grpc.py", False, NOTICE, Classification.GENERATED),
        ("foo/bar_pb2.pyi", False, NOTICE, Classification.GENERATED),
        ("foo/bar_pb2_grpc.pyi", True, NOTICE, Classification.GENERATED),
        ("foo/grammar/gen/FooLexer.py", False, NOTICE, Classification.GENERATED),
        ("foo/grammar/gen/FooParser.py", True, NOTICE, Classification.GENERATED),
        ("foo/grammar/gen/FooParserListener.py", False, NOTICE, Classification.GENERATED),
        ("foo/grammar/gen/FooParserVisitor.py", False, NOTICE, Classification.GENERATED),
        # other (always ERROR)
